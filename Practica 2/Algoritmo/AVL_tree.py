...
class AVLTree:
	...
	def getMax(self):
		if self.root!=None:
			currNode = self.root
			while currNode.right_child != None:
	...
	def getMin(self):
		if self.root!=None:
			currNode = self.root
			while currNode.left_child != None:
...
print("Maximum element is", a.getMax()) 
print("Minimum element is", a.getMin())
print("Search element is", a.search(9))
